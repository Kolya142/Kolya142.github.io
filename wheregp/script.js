...
// 5 - Added version counting. Added a reflexive "Me" contact.
// 6 - Now you'll have my contact by default without your personal consent :-)

if (!window.localization) {
    alert("There is no localization!!!");
}
